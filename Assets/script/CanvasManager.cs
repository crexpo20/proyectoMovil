...
public class CanvasManager : MonoBehaviour
{
    ...
    private void ConfigurarBotones()
    {
        ...
        if (botonPausaUI != null)
        {
            ...
            botonPausaUI.onClick.AddListener(() => {
            if (AudioManager.Instance != null) AudioManager.Instance.ReproducirBoton();
            TogglePausa();
            });
        }
        ...
        if (botonFJMenu != null)
        {
            ...
            botonFJMenu.onClick.AddListener(() => {
            if (AudioManager.Instance != null) AudioManager.Instance.ReproducirBoton();
            IrMenuPrincipal();
            });
        }
        if (botonFJFin != null)
        {
            ...
            botonFJFin.onClick.AddListener(() => {
            if (AudioManager.Instance != null) AudioManager.Instance.ReproducirBoton();
            ReiniciarNivel();
            });
        }
